...
class Player(Bot):
    '''
    The Blind Bandit is a simple pokerbot that only goes all-in with good hands.
    To make it less predictable some randomness is introduced.
    Also, it figured out a way to win by folding. Do you understand how?
    '''
